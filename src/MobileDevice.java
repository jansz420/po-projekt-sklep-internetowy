    ...
    public int editProduct() {
        ...
        switch(action) {
            ...
            case 16:
                ...
                break;
                case 17:
                    System.out.print("Podaj nowy battery capacity: ");
                    batteryCapacity = scanner.nextInt();
                    break;
                case 18:
                    System.out.print("Podaj nowy screen size: ");
                    screenSize = scanner.nextDouble();
                    break;
                case 19:
                    System.out.print("Podaj nowy resolution: ");
                    resolution = scanner.nextLine();
                    break;
                case 20:
                    System.out.print("Podaj nowy refresh rate: ");
